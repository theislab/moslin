...
.. csv-table::
    ...
    Zebrafish_coupling_analysis.R | Downstream analysis script to generate alluvial plots as shown in Figs. 4f and 4g, as well as visualization of the transition matrices (Figs. 4b and 4c, Supp. Fig. 20). Apart from the couplings generated in the previous step, the downstream analysis additionally uses data files for single-cell annotation, cell type colors, lineage information and sample timepoints found `here <https://figshare.com/account/projects/163357/articles/22502974>`_.
    Hyperparameters_with_persistency.py | Downstream analysis script to determine optimal hyperparameter values using the cell type persistency test and validating the optimal hyperparameters on transient fibroblasts. Used to generate Figs. 4d and 4e, as well as Supp. Figs. 17-19.
