    ...
    for dpi0 in hrts_tps[tps[0]]:
        ...
        for dpi3 in hrts_tps[tps[1]]:
            ...
            if not os.path.isfile(
                DATA_DIR
                / f"output/{dir_path}/tmat-{dpi0}_{dpi3}_alpha-{args.alpha}_epsilon-{args.epsilon}_beta-{args.beta}_taua-{args.tau_a}"
            ):
            ...
            for dpi7 in hrts_tps[tps[2]]:
                if not os.path.isfile(
                    DATA_DIR
                    / f"output/{dir_path}/tmat-{dpi3}_{dpi7}_alpha-{args.alpha}_epsilon-{args.epsilon}_beta-{args.beta}_taua-{args.tau_a}"
                ):
                    ...
                    if prob.solutions[list(prob.solutions.keys())[0]].converged:
                        ...
                        print(
                            f"tmat for alpha {args.alpha} and {dpi3}-{dpi7} is invalid"
                        )
